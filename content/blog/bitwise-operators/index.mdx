...
<Table caption="Bitwise & (AND)" className="font-mono">
...
<Table caption="Bitwise | (OR)" className="font-mono">
...
<Table caption="Bitwise ^ (XOR)" className="font-mono">
...
{/* {/\* <p className="text-center">Bitwise ~ (NOT)</p> */}

<Table caption="Bitwise ~ (NOT)" className="font-mono">
